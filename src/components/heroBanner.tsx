    ...
    <div className="relative w-full h-[520px] sm:h-[600px] lg:h-[650px] overflow-hidden bg-background border-b border-border">
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 right-0 z-30">
        <button
          ...
          className="group pointer-events-auto absolute left-4 top-1/2 -translate-y-1/2 flex h-12 w-12 items-center justify-center rounded-full backdrop-blur-md bg-black/30 border border-white/20 hover:bg-emerald-400/90 hover:border-emerald-300 transition-all duration-300"
        >
        ...
        <button
          ...
          className="group pointer-events-auto absolute right-4 top-1/2 -translate-y-1/2 flex h-12 w-12 items-center justify-center rounded-full backdrop-blur-md bg-black/30 border border-white/20 hover:bg-emerald-400/90 hover:border-emerald-300 transition-all duration-300"
        >
