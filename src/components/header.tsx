        ...
        <div className="flex items-center justify-between px-4 sm:px-6 md:px-8 py-4 max-w-7xl mx-auto h-20">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2">
            <Link to="/" className="cursor-pointer hover:opacity-80 transition-opacity">
              <h1 className="text-xl sm:text-2xl font-bold tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-primary via-lime-400 to-primary animate-gradient-x">
                CLICKEYS
              </h1>
            </Link>
          </div>
