        ...
        <div className="p-6 h-full overflow-y-auto">
          ...
          <div className="mb-6 pb-6 border-b border-outline-variant">
            <Link to="/bookmarks" onClick={onClose}>
              <Button
                variant="ghost"
                className="w-full justify-start text-foreground hover:bg-surface-bright cursor-pointer relative"
              >
                <MaterialIcon name="favorite" className="text-[16px] mr-3" />
            ...
            {menuItems.map((item) => (
              <div key={item.name}>
                <Link
                  ...
                  onClick={onClose}
                  className="text-left text-foreground hover:text-on-surface-variant transition-colors text-base cursor-pointer"
                >
                  {item.name}
                </Link>
              </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-100">
            <button className="text-left text-foreground hover:text-on-surface-variant transition-colors text-sm">
              Can we help you?
            </button>
          </div>
        </div>
