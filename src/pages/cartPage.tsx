    ...
    return (
      <main className="min-h-[70vh] flex flex-col items-center justify-center p-6 bg-background text-foreground">
        <div className="text-center space-y-6 max-w-sm mx-auto">
            ...
            <MaterialIcon name="shopping_bag" className="text-[40px] text-muted-foreground" />
          </div>
          ...
          <Button
            onClick={() => navigate("/")}
            className="w-full h-12 rounded-none font-semibold"
          >
            Start Shopping
          </Button>
        </div>
    ...
    <main className="min-h-screen bg-background text-foreground py-12 px-6 lg:px-12 transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12 border-b pb-8">
          ...
          >
            <MaterialIcon name="delete" className="text-[16px]" /> Clear all
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-8">
            {items.map((item) => (
              ...
              >
                {/* Product Image */}
                <div className="w-full sm:w-40 aspect-square bg-muted overflow-hidden flex-shrink-0">
                ...
                <div className="flex-1 flex flex-col justify-between py-1">
                  ...
                  <div className="flex items-center justify-between mt-6">
                    <div className="flex items-center border overflow-hidden bg-card h-10">
                      <button
                        onClick={() =>
                          dispatch(
                            updateCartItem({
            ...
            <div className="pt-4">
              ...
              >
                <MaterialIcon name="arrow_back" className="text-[16px]" /> Continue Shopping
              </Link>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-24 h-fit">
            <div className="bg-card border p-8 space-y-6 shadow-sm">
              ...
              <Link to="/checkout" className="block">
                <Button className="w-full h-14 text-lg font-bold flex items-center justify-center gap-2 shadow-lg shadow-primary/10">
                  Proceed to Checkout <MaterialIcon name="chevron_right" className="text-[20px]" />
                </Button>
              </Link>
